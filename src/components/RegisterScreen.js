...
export default function RegisterScreen() {
  ...
  const options = [
    ...
    {
      label: 'What is name of your uncle?',
      value: 'What is name of your uncle?',
      className: 'q2',
    },
    {
      label: 'What is name of your best friend?',
      value: 'What is name of your best friend?',
      className: 'q3',
    },
    {
      label: 'What is name of the city you were born?',
      value: 'What is name of the city you were born?',
      className: 'q4',
    },
  ];
